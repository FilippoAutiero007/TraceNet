...
import { AlertTriangle, Bug, FileUp, Loader2, Sparkles } from 'lucide-react';
...
export function PktAnalyzer({ onAnalysisComplete, getToken }: PktAnalyzerProps) {
    ...
    <Card className="w-full bg-slate-900 border-slate-800">
      <CardHeader>
        ...
        <CardDescription className="text-slate-400">
          Carica un file `.pkt` e ottieni una review tecnica con elenco delle correzioni, punti già corretti e confronto opzionale con la consegna dell'esercizio.
        </CardDescription>
      </CardHeader>
